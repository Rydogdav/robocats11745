...
import static org.firstinspires.ftc.teamcode.FTC745RobitTeleOp_v2_2_RELEASE.Kt;
import static org.firstinspires.ftc.teamcode.FTC745RobitTeleOp_v2_2_RELEASE.Strafe;
...
public class FTC745Drive_v2_0_RELEASE {
    public abstract static class DriveTeleOp extends LinearOpMode {
        ...
        public static void FieldCentricMecanum(double North, double East, double TurnCW) {
            ...
            if (motorFRightv != 0) {
                motorFRightv = motorFRightv * 0.95;
            }
            if (motorBLeftv != 0) {
